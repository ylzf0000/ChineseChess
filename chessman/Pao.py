...
class Pao(ChessPiece):
    ...
    def get_image_file_name(self):
        if self.selected:
            if self.is_red:
                return ExpDef.image_chess_path + "RCS.GIF"
            else:
                return ExpDef.image_chess_path + "BCS.GIF"
        else:
            if self.is_red:
                return ExpDef.image_chess_path + "RC.GIF"
            else:
                return ExpDef.image_chess_path + "BC.GIF"
